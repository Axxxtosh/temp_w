 ...
 */
public class TTNNetChangeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter1 = new TTNNetChangeFragment.Adapter(internetPacksList,getContext());
        getData();
    ...
    public class Adapter extends RecyclerView.Adapter<TTNNetChangeFragment.Adapter.ViewHolder> {

        private ImageLoader imageLoader;
        private Context context;
        TTNNetChangeFragment sub;
        ...
        @Override
        public TTNNetChangeFragment.Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.internetpack_change_row, parent, false);
            TTNNetChangeFragment.Adapter.ViewHolder viewHolder = new TTNNetChangeFragment.Adapter.ViewHolder(v);
            sub = new TTNNetChangeFragment();
            return viewHolder;
        }


        @Override
        public void onBindViewHolder(TTNNetChangeFragment.Adapter.ViewHolder holder, final int position) {
