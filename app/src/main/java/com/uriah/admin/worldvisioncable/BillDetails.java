 ...
 */
public class BillDetails extends Fragment implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_bill_details, container, false);
    ...
    private void intialiseViewPager() {
        ...
        fragments.add(Fragment.instantiate(getActivity(), AccountStatement.class.getName()));
        fragments.add(Fragment.instantiate(getActivity(), PaymentHistory.class.getName()));
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        BillDetails.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("A/C Statement").setIndicator("A/C Statement"), ( tabInfo = new TabInfo("A/C Statement", AccountStatement.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);

        BillDetails.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Payment History").setIndicator("Payment History"), ( tabInfo = new TabInfo("Payment History", PaymentHistory.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
    ...
    private static void AddTab(BillDetails activity, TabHost tabHost, TabHost.TabSpec tabSpec,TabInfo tabInfo) {
