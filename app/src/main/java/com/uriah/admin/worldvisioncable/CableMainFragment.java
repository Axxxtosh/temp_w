 ...
 */
public class CableMainFragment extends Fragment implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_cable_main, container, false);
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Prime").setIndicator("Prime"), ( tabInfo = new TabInfo("Prime", CableTvFragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
    ...
    private static void AddTab(CableMainFragment activity, TabHost tabHost, TabHost.TabSpec tabSpec,TabInfo tabInfo) {
